...
class ScrollingFrameAndView(tk.Frame):
    def __init__(self, parent):
        ...
        self.canvas = tk.Canvas(self, borderwidth=0)#, width=200)
        self.frame = ttk.Frame(self.canvas)#, width=200)
        ...
        self.display_frame = ttk.Labelframe(self, text='Email Text:')#, width=200)
